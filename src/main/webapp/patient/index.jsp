        ...
        <div class="min-h-full">
            ...
            <div class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
                ...
                <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
                    ...
                    <div class="flex-shrink-0 flex items-center px-4">
                        <img class="h-8 w-auto" src="https://imgs.search.brave.com/HtbJt6kxB1qcEzxTPBikAh7Y05ioSmMpGMvnMElbtJk/rs:fit:748:512:1/g:ce/aHR0cHM6Ly9yYWRp/b3RldG91YW4ubWEv/d3AtY29udGVudC91/cGxvYWRzLzIwMTkv/MDcvY25zcy5sb2dv/Xy5qcGc" alt="CNSS">
                    </div>
            ...
            <div class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-gray-100">
                <div class="flex items-center flex-shrink-0 px-6">
                    <img class="h-8 w-20" src="https://imgs.search.brave.com/fog2xHIDnCXVHjzNcyQQ7yWy2kkuSrWydlIJquTLhcs/rs:fit:287:300:1/g:ce/aHR0cHM6Ly9zZWVr/bG9nby5jb20vaW1h/Z2VzL0MvY25zcy1s/b2dvLTJFOERGRkJC/MkEtc2Vla2xvZ28u/Y29tLnBuZw" alt="CNSS">
                </div>
